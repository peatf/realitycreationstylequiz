...
export const createShareableUrl = (dimensionScores, profileId) => {
  ...
  const baseUrl = typeof window !== 'undefined' 
    ...
    : 'https://your-squarespace-domain.com/results';
...
export const generateShareText = (profileName) => {
  return `I took the Reality Creation Style Assessment and discovered I'm "${profileName}"! Discover your reality creation style too:`;
};
