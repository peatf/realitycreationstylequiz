        ...
        <div className="space-y-3 mb-8">
          {metricOptions.map((option) => (
            <div
              ...
              style={{ 
                borderWidth: "1px",
                borderColor: adaptiveMasteryMetric === option.id ? "#2359FF" : "rgba(193,191,132,0.4)",
                background: adaptiveMasteryMetric === option.id ? "rgba(235,240,180,0.95)" : "rgba(235,240,180,0.6)"
              }}
            >
