  ...
  return (
    <div className="flex items-start justify-center w-full min-h-screen" style={{ background: "transparent" }}>
      ...
      <div className="relative w-full max-w-2xl mx-auto mt-10 mb-10 p-8 z-10">
              ...
              return (
                <div key={dimension.id} className="mb-6">
                  <div className="flex justify-between mb-2">
                    <span className="text-xs font-light" style={{ color: "#2359FF", textAlign: "left", width: "30%" }}>{dimension.leftLabel}</span>
                    <span className="text-xs font-light" style={{ color: "#2359FF", textAlign: "center", width: "30%" }}>{dimension.title}</span>
                    <span className="text-xs font-light" style={{ color: "#2359FF", textAlign: "right", width: "30%" }}>{dimension.rightLabel}</span>
                  </div>
        ...
        {/* Share Section */}
        <div className="mb-8">
          <h3 className="text-xl font-thin tracking-widest text-center mb-4" style={{ color: "#2359FF" }}>
            Share Your Results
          </h3>
          <div 
